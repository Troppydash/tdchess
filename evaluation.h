...
int32_t gamephaseInc[12] = {0, 0, 1, 1, 1, 1, 2, 2, 4, 4, 0, 0};
...
int32_t evaluate(const chess::Board &board)
{
    ...
    for (int sq = 0; sq < 64; ++sq)
    {
        auto pc = board.at(chess::Square{sq});
