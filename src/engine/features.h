...
/// SEARCH PARAMETERS ///
TUNE(HISTORY_MULT, 180, 0, 100, 300);
TUNE(HISTORY_BASE, 15, 0, -100, -40);
TUNE(MAX_HISTORY_UPDATE, 2000, 0, 1000, 2000);

TUNE(HISTORY_MALUS_MULT, 190, 0, 100, 300);
TUNE(HISTORY_MALUS_BASE, -30, 0, -100, -40);

TUNE(SNM_MARGIN, 100, 0, 25, 150);
...
TUNE(QUIET_BAD_THRESHOLD, -15000, 1, -7000, -3000);

TUNE(TB_HIT_DEPTH, 0, 1, 0, 10);
