...
// TUNE(HISTORY_MULT, 64, 2, 16, 128);
// TUNE(HISTORY_BASE, 1, 3, -100, 100);
//
// TUNE(HISTORY_MALUS_MULT, 65, 2, 16, 128);
// TUNE(HISTORY_MALUS_BASE, 1, 3, -100, 100);
//
// TUNE(SNM_MARGIN, 87, 2, 25, 150);
//
// TUNE(NMP_DEPTH, 0, 0.2, 0, 10);
// TUNE(NMP_REDUCTION_MULT, 3, 0.2, 1, 10);
// TUNE(NMP_REDUCTION_BASE, 4, 0.2, 1, 10);
