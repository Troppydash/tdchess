...
namespace pesto
{
constexpr int32_t mg_value[6] = {82, 337, 365, 477, 1025, 0};
constexpr int32_t eg_value[6] = {94, 281, 297, 512, 936, 0};

constexpr int32_t mg_pawn_table[64] = {
...
constexpr int32_t eg_pawn_table[64] = {
...
constexpr int32_t mg_knight_table[64] = {
...
constexpr int32_t eg_knight_table[64] = {
...
constexpr int32_t mg_bishop_table[64] = {
...
constexpr int32_t eg_bishop_table[64] = {
...
constexpr int32_t mg_rook_table[64] = {
...
constexpr int32_t eg_rook_table[64] = {
...
constexpr int32_t mg_queen_table[64] = {
...
constexpr int32_t eg_queen_table[64] = {
...
constexpr int32_t mg_king_table[64] = {
...
constexpr int32_t eg_king_table[64] = {-74, -35, -18, -18, -11, 15, 4,  -17, -12, 17,  14,  17,  17,  38,  23,  11,
...
constexpr std::array<const int32_t *, 6> mg_pesto_table = {mg_pawn_table, mg_knight_table, mg_bishop_table,
                                                           mg_rook_table, mg_queen_table,  mg_king_table};

constexpr std::array<const int32_t *, 6> eg_pesto_table = {eg_pawn_table, eg_knight_table, eg_bishop_table,
...
inline void init()
{
    ...
    initialized = true;
    for (int p = static_cast<int>(chess::Piece::WHITEPAWN); p <= static_cast<int>(chess::Piece::WHITEKING); ++p)
    {
...
inline int32_t evaluate(const chess::Board &board)
{
    int mg[2] = {0, 0};
    int eg[2] = {0, 0};
    int gamePhase = 0;
    ...
    for (int sq = 0; sq < 64; ++sq)
    {
        const auto &pc = board.at(chess::Square{sq});
    ...
    /* tapered eval */
    int side2move = board.sideToMove();
